/**
 * Site Supervisor Role Permissions
 * Based on Material Purchases - Project Bound Workflow
 * Site Supervisor initiates purchase requests and sends to Procurement
 */

import { RolePermissions } from '../procurement/permissions';

export const siteSupervisorPermissions: RolePermissions = {
  purchaseRequests: {
