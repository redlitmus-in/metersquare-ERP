...
const SiteSupervisorMetricsCarousel: React.FC<{ metrics: MetricCard[] }> = ({ metrics }) => {
  ...
  return (
    <div className="p-4 sm:p-6 bg-gray-50 min-h-screen [&_*:focus]:outline-none [&_*:focus]:ring-0">
      ...
      <div className="px-6 py-4">
        <SiteSupervisorMetricsCarousel metrics={[
          {
                              ...
                              {activeTab === 'pending' && (
                                <>
                                  ...
                                  <Button
                                    ...
                                    disabled={sendingEmailFor === purchase.purchase_id}
